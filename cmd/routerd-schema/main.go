...
func resourceUnionSchema() map[string]any {
	return map[string]any{
		"oneOf": []any{
			...
			resourceSchema(api.NetAPIVersion, "DHCPv4ServerLeaseSync", api.DHCPv4ServerLeaseSyncSpec{}),
			resourceSchema(api.NetAPIVersion, "DHCPv6ServerLeaseSync", api.DHCPv6ServerLeaseSyncSpec{}),
			resourceSchema(api.NetAPIVersion, "DHCPv6PrefixDelegationLeaseSync", api.DHCPv6PrefixDelegationLeaseSyncSpec{}),
			...
			resourceSchema(api.MobilityAPIVersion, "SAMTransportProfile", api.SAMTransportProfileSpec{}),
