...
func usage(w io.Writer) {
	...
	fmt.Fprintln(w, "  mobility leaf-config --leaf-id <name> --underlay-ifname <ifname> --underlay-address <cidr> --local-endpoint <ip> --endpoint-prefix <cidr> --inner-prefix <cidr> --tunnel-address <ipv4/32> --mobility-prefix <cidr> --owned-address <ipv4/32> --rr-set <name> --policy <name> --join-audience <name> --bootstrap-endpoint <url>")
