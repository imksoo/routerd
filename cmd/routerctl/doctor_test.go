...
func TestDoctorSAMOwnerTableReportsUnexpectedRouteResidue(t *testing.T) {
	...
	if check.Status != doctorWarn || !strings.Contains(check.Detail, "absent from ownershipResolverControlPlaneOwnerTable") || !strings.Contains(check.Detail, "10.77.60.8 dev ens5") {
