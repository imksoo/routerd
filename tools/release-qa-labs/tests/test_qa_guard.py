...
class ContractGuardTests(unittest.TestCase):
    ...
    def test_paid_envelope_overrun_and_one_cent_over_ceiling_are_rejected(self):
        ...
        self.assertEqual(qa_guard.estimated_cost(8700), 1.55)
        self.contract["limits"]["maxEstimatedCostUsd"] = 1.54
...
class PlanGuardTests(unittest.TestCase):
    ...
    def test_exact_cloud_plan_passes(self):
        # The real closed cloud plan includes four deferred OCI VNIC reads.
        value = json.loads((Path(__file__).parent / "fixtures/cloud-plan-vnic-reads.json").read_text())
        write_json(self.path, value)
