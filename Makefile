...
AWS_ROUTERD_HELPER_BIN := $(BUILDDIR)/aws-routerd-helper
AZURE_ROUTERD_HELPER_BIN := $(BUILDDIR)/azure-routerd-helper
OCI_ROUTERD_HELPER_BIN := $(BUILDDIR)/oci-routerd-helper
ROUTERD_PROVIDER_EXECUTOR_BINS := $(AWS_PROVIDER_EXECUTOR_BIN) $(AZURE_PROVIDER_EXECUTOR_BIN) $(OCI_PROVIDER_EXECUTOR_BIN) $(AWS_ROUTERD_HELPER_BIN) $(AZURE_ROUTERD_HELPER_BIN) $(OCI_ROUTERD_HELPER_BIN)
...
build-provider-executors:
	...
	$(GO_BUILD_ENV) go build $(GO_BUILD_FLAGS) -o $(AWS_ROUTERD_HELPER_BIN) ./examples/plugins/aws-routerd-helper
	$(GO_BUILD_ENV) go build $(GO_BUILD_FLAGS) -o $(AZURE_ROUTERD_HELPER_BIN) ./examples/plugins/azure-routerd-helper
	$(GO_BUILD_ENV) go build $(GO_BUILD_FLAGS) -o $(OCI_ROUTERD_HELPER_BIN) ./examples/plugins/oci-routerd-helper
...
dist:
	...
	install -d $(DISTROOT)/libexec/routerd/plugins/aws-routerd-helper/bin
	install -m 0755 $(AWS_ROUTERD_HELPER_BIN) $(DISTROOT)/libexec/routerd/plugins/aws-routerd-helper/bin/aws-routerd-helper
	...
	install -d $(DISTROOT)/libexec/routerd/plugins/azure-routerd-helper/bin
	install -m 0755 $(AZURE_ROUTERD_HELPER_BIN) $(DISTROOT)/libexec/routerd/plugins/azure-routerd-helper/bin/azure-routerd-helper
	...
	install -d $(DISTROOT)/libexec/routerd/plugins/oci-routerd-helper/bin
	install -m 0755 $(OCI_ROUTERD_HELPER_BIN) $(DISTROOT)/libexec/routerd/plugins/oci-routerd-helper/bin/oci-routerd-helper
