...
| 想做什么 | 从这里开始 |
| --- | --- |
| 了解 routerd 是什么、为何存在 | [概念 → routerd 是什么](/docs/concepts/what-is-routerd) |
| 第一次架路由器 | [教程 → 入门](/docs/tutorials/getting-started) |
| 解决特定部署场景 | [How-to 指南](/docs/how-to/multi-wan) |
| 查阅资源 Kind 或字段 | [参考 → Resource API](/docs/reference/api-v1alpha1) |
| 运维运行中的路由器 | [运维 → Reconcile](/docs/operations/reconcile) |
| 看实战场景的背景笔记 | [知识库](/docs/knowledge-base/dhcpv6-pd-clients) |
| 了解最近变动 | [版本 → Changelog](/docs/releases/changelog) |
