...
日常使用请从 [教程](./tutorials/getting-started.md) 与 [How-to](./how-to/multi-wan.md) 开始。
资源定义请参照 [API 参考](./api-v1alpha1.md)。
...
详见 [资源模型](./concepts/resource-model.md) 与 [状态与所有权](./concepts/state-and-ownership.md)。
...
详见 [reconcile loop 行为](./operations/reconcile.md)。
...
详见 [日志存储](./concepts/log-storage.md)。

---

## 8. 相关文档

- [何为 routerd](./concepts/what-is-routerd.md)
- [资源模型](./concepts/resource-model.md)
- [设计理念](./concepts/design-philosophy.md)
- [apply 与 render](./concepts/apply-and-render.md)
- [状态与所有权](./concepts/state-and-ownership.md)
- [reconcile loop](./operations/reconcile.md)
- [状态 DB 运维](./operations/state-database.md)
- [API 参考 v1alpha1](./api-v1alpha1.md)
- [Plugin 协议](./plugin-protocol.md)
- [支持平台](./platforms.md)
