...
![DNSZone 組合 manual record、DHCP-derived lease record、reverse zone、event relay update 與 DNSResolver local answer 的流程](/img/diagrams/how-to-dns-local-zone.png)
