...
日常使用請從 [教學](/docs/tutorials/getting-started) 與 [How-to](/docs/how-to/multi-wan) 開始。
資源定義請參照 [API 參考](/docs/reference/api-v1alpha1)。
...
詳見 [資源模型](/docs/concepts/resource-model) 與 [狀態與所有權](/docs/concepts/state-and-ownership)。
...
詳見 [reconcile loop 行為](/docs/operations/reconcile)。
...
詳見 [日誌儲存](/docs/concepts/log-storage)。

---

## 8. 相關文件

- [何謂 routerd](/docs/concepts/what-is-routerd)
- [資源模型](/docs/concepts/resource-model)
- [設計理念](/docs/concepts/design-philosophy)
- [apply 與 render](/docs/concepts/apply-and-render)
- [狀態與所有權](/docs/concepts/state-and-ownership)
- [reconcile loop](/docs/operations/reconcile)
- [狀態 DB 運維](/docs/operations/state-database)
- [API 參考 v1alpha1](/docs/reference/api-v1alpha1)
- [Plugin 協定](/docs/reference/plugin-protocol)
- [支援平台](/docs/platforms)
