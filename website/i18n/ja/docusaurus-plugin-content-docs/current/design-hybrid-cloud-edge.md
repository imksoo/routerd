...
![MobilityPool と SAMTransportProfile から DynamicConfigPart、IPIP TunnelInterface delivery、BGP peer、ECMP 対応 FIB path、endpoint 専用 WireGuard underlay へつながる CloudEdge SAM 図](/img/diagrams/cloudedge-sam-ipip.png)
