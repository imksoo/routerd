...
Linux arm64 ホストでは `routerd-20260509.13-linux-arm64.tar.gz` を使います。

FreeBSD では `routerd-20260509.13-freebsd-amd64.tar.gz` を取得し、同じ
`./install.sh` を実行します。
FreeBSD arm64 ホストでは `routerd-20260509.13-freebsd-arm64.tar.gz` を使います。
