...
```sh
fetch https://github.com/imksoo/routerd/releases/download/20260509.14/routerd-20260509.14-freebsd-amd64.tar.gz
tar -xzf routerd-20260509.14-freebsd-amd64.tar.gz
sudo ./install.sh
```
