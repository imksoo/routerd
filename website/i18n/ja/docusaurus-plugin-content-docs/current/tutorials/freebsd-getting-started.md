...
```sh
fetch https://github.com/imksoo/routerd/releases/download/20260509.11/routerd-20260509.11-freebsd-amd64.tar.gz
tar -xzf routerd-20260509.11-freebsd-amd64.tar.gz
sudo ./install.sh
```
