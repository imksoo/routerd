...
![SAMTransportProfile が生成する IPIP delivery を endpoint 専用 WireGuard underlay の上に載せ、mobile /32 は BGP と kernel FIB が扱うことを示す CloudEdge SAM transport 図](/img/diagrams/cloudedge-sam-ipip.png)
