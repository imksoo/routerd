...
routerd は、Linux ホスト、NixOS、FreeBSD をルーターとして動かすための宣言的な制御プレーンです。
...
- `routerd-dns-resolver`: DNS ゾーン応答と DoH、DoT、TCP、UDP 上流を担当します。
