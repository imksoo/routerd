...
| Resource | 設定 |
| --- | --- |
| `VirtualAddress/k8s-api-vip` | VRRP の preempt 設定、API health と BGP health の track。 |
...
| `BGPRouter/lan` | `convergenceProfile: fast`、BGP timers `3s/9s/5s`、既定で graceful restart disabled、Kubernetes Service prefix だけを受ける import allow-list。 |
