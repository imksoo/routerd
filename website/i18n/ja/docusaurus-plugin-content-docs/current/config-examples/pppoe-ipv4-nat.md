...
![Ethernet 回線上の PPPoE、routerd PPPoESession、LAN DHCP、PPP インターフェース向け NAT44 の構成](/img/diagrams/config-example-pppoe-ipv4-nat.png)
...
| IPv4 インターネット接続 | `NAT44Rule/lan-to-pppoe` |
