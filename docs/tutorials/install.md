...
On Linux arm64 hosts, use `routerd-20260509.13-linux-arm64.tar.gz`.

For FreeBSD, download `routerd-20260509.13-freebsd-amd64.tar.gz` and run the
same `./install.sh`.
On FreeBSD arm64 hosts, use `routerd-20260509.13-freebsd-arm64.tar.gz`.
