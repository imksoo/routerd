...
[v20260725.0248](https://github.com/imksoo/routerd/releases/tag/v20260725.0248).

Linux amd64:

```sh
curl -LO https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-linux-amd64.tar.gz
curl -LO https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-linux-amd64.tar.gz.sha256
...
```sh
fetch https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-freebsd-amd64.tar.gz
fetch https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-freebsd-amd64.tar.gz.sha256
...
`routerd-v20260725.0248-linux-amd64.tar.gz`.
...
```sh
curl -LO https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-ndpi-agent-libndpi-linux-amd64.tar.gz
curl -LO https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-ndpi-agent-libndpi-linux-amd64.tar.gz.sha256
...
```sh
curl -LO https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-live.iso
curl -LO https://github.com/imksoo/routerd/releases/download/v20260725.0248/routerd-live.iso.sha256
