...
[v20260731.1649](https://github.com/imksoo/routerd/releases/tag/v20260731.1649).

Linux amd64:

```sh
curl -LO https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-linux-amd64.tar.gz
curl -LO https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-linux-amd64.tar.gz.sha256
...
```sh
fetch https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-freebsd-amd64.tar.gz
fetch https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-freebsd-amd64.tar.gz.sha256
...
`routerd-v20260731.1649-linux-amd64.tar.gz`.
...
```sh
curl -LO https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-ndpi-agent-libndpi-linux-amd64.tar.gz
curl -LO https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-ndpi-agent-libndpi-linux-amd64.tar.gz.sha256
...
```sh
curl -LO https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-live.iso
curl -LO https://github.com/imksoo/routerd/releases/download/v20260731.1649/routerd-live.iso.sha256
