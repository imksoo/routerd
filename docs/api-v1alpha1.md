...
| `MobilityPool` | `advertisementGatePhase` (string), `blockingReasons` (stringList), `cloudClaimPhase` (string), `deliveryMode` (string), `discoverySelfPrivateIPs` (stringList), `dynamicSource` (string), `fibConvergencePhase` (string), `forwardingPhase` (string), `generatedActions` (int), `generatedBGPPaths` (int), `generatedBGPTraps` (int), `groupRef` (string), `lastObservedAt` (timestamp), `memberSet` (object), `membersFrom` (objectList), `osCapturePhase` (string), `pendingSources` (stringList), `placementActive` (bool), `placementActiveNode` (string), `placementGroup` (string), `plannerPhase` (string), `plannerReason` (string), `prefix` (string), `resolvedMemberCount` (int), `samConvergencePhase` (string), `splitBrainDetected` (bool), `staleEpochDetected` (bool) |
