...
func TestKnownResourceKindsDeclareArtifactIntents(t *testing.T) {
	...
	resources := []api.Resource{
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "DHCPv4Server"}, Metadata: api.ObjectMeta{Name: "lan-scope"}, Spec: api.DHCPv4ServerSpec{Interface: "lan"}},
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "DHCPv4Reservation"}, Metadata: api.ObjectMeta{Name: "printer-v2"}, Spec: api.DHCPv4ReservationSpec{MACAddress: "aa:bb:cc:dd:ee:01", IPAddress: "192.168.10.51"}},
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "DHCPv6Server"}, Metadata: api.ObjectMeta{Name: "lan-v6-scope"}, Spec: api.DHCPv6ServerSpec{}},
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "DNSForwarder"}, Metadata: api.ObjectMeta{Name: "local"}, Spec: api.DNSForwarderSpec{Resolver: "DNSResolver/lan-resolver", Match: []string{"lab.example"}, ZoneRefs: []string{"DNSZone/lan-zone"}}},
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "DNSUpstream"}, Metadata: api.ObjectMeta{Name: "cloudflare"}, Spec: api.DNSUpstreamSpec{Protocol: "udp", Address: "1.1.1.1"}},
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "EgressRoutePolicy"}, Metadata: api.ObjectMeta{Name: "default-v4"}, Spec: api.EgressRoutePolicySpec{Mode: "priority", Candidates: []api.EgressRoutePolicyCandidate{{Name: "pppoe", Interface: "wan-pppoe", Priority: 10, Mark: 0x111, Table: 111}}}},
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "EgressRoutePolicy"}, Metadata: api.ObjectMeta{Name: "policy"}, Spec: api.EgressRoutePolicySpec{Mode: "mark", Candidates: []api.EgressRoutePolicyCandidate{{Interface: "wan", Priority: 100, Mark: 0x120, Table: 120}}}},
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "EgressRoutePolicy"}, Metadata: api.ObjectMeta{Name: "set"}, Spec: api.EgressRoutePolicySpec{Mode: "hash", HashFields: []string{"sourceAddress"}, Candidates: []api.EgressRoutePolicyCandidate{{Name: "set", Targets: []api.EgressRoutePolicyTarget{{Interface: "transix-a", Priority: 10000, Mark: 0x100, Table: 100}}}}}},
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "DHCPv4Reservation"}, Metadata: api.ObjectMeta{Name: "printer"}, Spec: api.DHCPv4ReservationSpec{Server: "lan-scope", MACAddress: "aa:bb:cc:dd:ee:ff", IPAddress: "192.168.10.50"}},
