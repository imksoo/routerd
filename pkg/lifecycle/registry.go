...
var declarations = []Declaration{
	...
	declare(api.MobilityAPIVersion, "MobilityPool", ClassDynamicSource, "SAM capture/control-plane dynamic source", noHostTeardown("dynamic source emits a typed MobilityDataplane plan handled by dedicated local effectors")),
