	...
	router := &api.Router{
		...
		Spec: api.RouterSpec{Resources: []api.Resource{
			...
			},
			{
				...
				Spec:     api.InterfaceSpec{IfName: "ens21", Managed: true, Owner: "routerd"},
			},
			{
				TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "VRF"},
				Metadata: api.ObjectMeta{Name: "guest-vrf"},
