...
func FreeBSDWithPPPoEPasswords(router *api.Router, passwordFor func(api.Resource, api.PPPoEInterfaceSpec) (string, error)) (FreeBSDConfig, error) {
	...
	return FreeBSDConfig{RCConf: rc.Bytes(), NTP: ntpConfig, DHCPClient: dhclient, MPD5: mpd5, PF: pf, PackageInstall: packageInstall, RCDScripts: rcdScripts, Warnings: warnings}, nil
}
...
func freeBSDPackageInstallScript(router *api.Router) ([]byte, error) {
	...
	buf.WriteString("# Generated by routerd. Installs missing FreeBSD packages declared by Package resources.\n")
