...
func FreeBSD(router *api.Router) (FreeBSDConfig, error) {
	...
	for _, res := range router.Spec.Resources {
		...
		case "IPv6PrefixDelegation":
			...
			pds = append(pds, freeBSDPD{Name: res.Metadata.Name, IfName: ifname, PrefixLength: effectiveIPv6PDPrefixLength(defaultString(spec.Profile, "default"), spec.PrefixLength)})
		}
	}
