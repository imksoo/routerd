...
func TestFreeBSDRendersRouter01Basics(t *testing.T) {
	...
	router := &api.Router{Spec: api.RouterSpec{Resources: []api.Resource{
		...
		{TypeMeta: api.TypeMeta{APIVersion: api.NetAPIVersion, Kind: "Bridge"}, Metadata: api.ObjectMeta{Name: "lan-bridge"}, Spec: api.BridgeSpec{IfName: "bridge0", Members: []string{"lan"}, RSTP: boolPtr(true)}},
	...
	for _, want := range []string{
		...
		`ifconfig_bridge0="addm vtnet1 rstp vtnet1 up"`,
